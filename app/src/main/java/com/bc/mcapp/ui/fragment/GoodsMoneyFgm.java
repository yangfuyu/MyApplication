 ...
 */
public class GoodsMoneyFgm extends Fragment implements GoodsInfo {
    View view;
    @ViewInject(R.id.fgm_gods_RcylView3)
    RecyclerView fgm_gods_RcylView3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=LayoutInflater.from(getActivity()).inflate(R.layout.fgm_gods_money_lin,null);
        ...
        fgm_gods_RcylView3.addItemDecoration(new DividerItemDecoration(getActivity(),1));
        fgm_gods_RcylView3.setLayoutManager(linMan);

        if( ((GoodsInfoActivity)getActivity()).sendBoolean2){
            boolean bol=((GoodsInfoActivity)getActivity()).sendBoolean2;
    ...
    public void showGoodsTypeData(Conditions_data data) {
        if(data != null){
            ...
            fgm_gods_RcylView3.setAdapter(adapter);
        }
    }
